...
class AdapterInventario(private val listado: List<Inventariomodel>?) :
    RecyclerView.Adapter<AdapterInventario.ViewHolder>() {
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.card_item_inventario, viewGroup, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemclave = itemView.findViewById(R.id.claveproducto)
